/*
===============================================================================
 * Name			:My_Femto_Shell.c
 * Author		:Omar Elshamy
 * Description     	:Make shell do commands 
 * Created on   	:Feb, 2024
===============================================================================
*/
/*
 ...
 * Name: count_arg
 * Description :
 * This function count the number arguments of tokens.
 * APIS: take content on bufer
 ...
 * Name: parsing
 * Description :
 * This function parse the command line to argumets and store it in array, skip spaces between arguments.
 * APIS: take buffer content, array of tokens and number of tokens
 * return: Nothing
 */
void
 ...
 * Name: main
 * Description :
 * This is Main function to do commands.
 */
...
//Free bufer to resive another command    
    n = 0;
    free (buf);
  }
  return 0;
